...
namespace cnpy {
    ...
    void parse_npy_header(std::istream& stream,size_t& word_size, std::vector<size_t>& shape, bool& fortran_order);
    void parse_npy_header(unsigned char* buffer,size_t& word_size, std::vector<size_t>& shape, bool& fortran_order);
    void parse_zip_footer(std::istream& stream, uint16_t& nrecs, size_t& global_header_size, size_t& global_header_offset);
